...
public class JvmComprehension {                                      - Подготовка к исполнению:
    ...
    }                                                                 По выходу из вызванных методов ссылки на созданные ими объекты в куче удаляются, указатель стека
                                                                      сдвигается вниз. При запуске сборщика мусора размер используемого хипа уменьшается, объекты из кучи
                                                                      удаляются.
}
```
